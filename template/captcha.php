...
// Modify this by removing the two '/' at the beggining of the line or changing the number of dots or line for making the captcha harder)
//$random_captcha_dots = 50; // Modify this  for changing the number of dots in the captcha
//$random_captcha_lines = 25; // Modify this for changing the number of lines in the captcha
//$captcha_text_color = "0x142864"; // Modify this for changing the color of the captcha
